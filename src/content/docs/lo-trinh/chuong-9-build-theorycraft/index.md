...
- **[Chọn & theo build đúng cách](/POE2/lo-trinh/chuong-9-build-theorycraft/chon-va-theo-build/)** — Trả lời thẳng câu "nên theo build nào, build đó chú ý gì, ưu tiên gì": tìm build ở đâu cho patch hiện tại (Maxroll, poe.ninja), chọn build hợp người mới, đọc một build guide đúng thứ tự, tách phần lõi rẻ với món carry đắt, **theo build sao cho không hỏng** (giữ kháng, không bỏ phòng thủ, đúng gem/cơ chế, đúng ưu tiên đồ), và tự kiểm trong PoB2 xem build có "chạy" không. Bài "theo một build cho đúng" — bổ trợ cho bài đọc meta ở trên.
